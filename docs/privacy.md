...
1. 为向您提供游戏服务，我们将依据《【汉末乡野村】隐私政策》收集、使用、存储必要的信息。
...
请您阅读完整版《【汉末乡野村】用户协议》及《【汉末乡野村】隐私政策》了解详细信息。

如您同意《【汉末乡野村】用户协议》及《【汉末乡野村】隐私政策》，请您点击“同意”开始使用我们的产品和服务，我们将尽全力保护您的个人信息安全。
...
【汉末工作室】（注册地址：广东省广州市天河路天龙大厦501，以下简称“**我们**”）系移动应用程序“【汉末乡野村】”（以下简称“【汉末乡野村】”）的运营者。我们非常重视保护用户（以下简称“**您**”）的个人信息和隐私。您在使用【汉末乡野村】时，我们会收集、使用、保存、共享您的相关个人信息。为呈现我们处理您个人信息的情况，我们特制定《【汉末乡野村】隐私政策》（以下简称“**隐私政策**”），我们承诺严格按照本隐私政策处理您的个人信息。

我们在此提醒您：

**在您使用【汉末乡野村】前，请您务必认真阅读本隐私政策，充分理解各条款内容，包括但不限于免除或限制我们责任的条款。您知晓并确认，您勾选“同意”本隐私政策并使用【汉末乡野村】，就表示您同意我们按照本隐私政策处理您的个人信息。**请您知悉，本政策仅适用于我们通过【汉末乡野村】向您提供服务所收集的信息，不适用于通过接入【汉末乡野村】以向您提供产品或服务的第三方所收集的信息。
...
在您使用【汉末乡野村】过程中，我们会按照如下方式收集您的个人信息：

1. **完成注册**

当您注册【汉末乡野村】账户时，我们需要收集您的手机号码、登录密码、【数据类型】。我们收集您的上述信息是为了帮助您完成【汉末乡野村】账户的注册，保护您的账户安全，如您不提供这类信息，我们将无法为您创建账户并正常向您提供服务。
...
当您进行实名认证时，我们需要收集您的姓名、身份证件类型、身份证件号码、【数据类型】。同时，为实现实名认证的目的，您同意并授权我们自行或委托第三方向有关实名认证机构（如个人征信机构、政府部门等）提供、查询、核对您的前述身份信息。我们收集您的上述信息是为了履行法定义务，核验用户真实身份、识别用户年龄以及保障系统和服务安全。如您不提供这类信息，您将无法登录【汉末乡野村】或在使用【汉末乡野村】过程中受到相应限制。
...
在您使用【汉末乡野村】过程中，我们需要在必要范围内向您申请获取设备权限。**请您知悉，我们不会默认开启您设备的权限，仅在您主动确认开启的情况下，【汉末乡野村】才有可能通过设备权限收集您的信息。**【汉末乡野村】调用的权限、调用权限的目的，以及调用权限前向您询问的情况请见下表：
...
2. **如果您的浏览器或浏览器附加服务允许，您可修改对Cookies的接受程度或拒绝我们的Cookies。有关详情，请参见https://www.aboutcookies.org/。但如果您这么做，在某些情况下可能会影响您安全使用我们的产品或服务。****同时，您仍然将收到****商品或服务信息，只是这些商品或服务信息与您的相关性会降低。**
3. **我们如何使用同类技术**
...
5. **与我们的业务合作伙伴共享。我们可能会将您的个人信息共享【业务合作伙伴的类型】。我们共享这些信息的目的是为实现服务所必需，比如我们需要将您的【数据类型】共享给【业务合作伙伴的类型】以向您提供【服务名称】服务。**
6. **转让**
...
在您使用【汉末乡野村】期间，您可以通过相应页面提示或本隐私政策载明的方式联系我们，以访问、更正、删除您的个人信息，以及行使改变授权同意的范围与注销账号的权利，您的意见会及时得到处理。
...
请您理解，【汉末乡野村】可能需要开启部分权限并收集必要的个人信息才能得以实现。当您撤回您的同意时，我们将无法继续为您提供撤回同意所对应的服务，但不会影响此前基于您的授权而开展的个人信息处理服务。
